                  ...
                  <n-space justify="center">
                    <div style="padding-bottom: 10px;">
                      ...
                      <n-modal v-model:show="showQQRMod">
                        <n-card style="width: 600px" title=" " :bordered="false" size="huge" role="dialog"
                          aria-modal="true" class="glassmorphism">
                          <template #header-extra>
                            使用手机QQ扫描二维码或搜索群号：694320039
                          </template>
                          <img src="https://bitnp-website-1258614279.cos.ap-beijing.myqcloud.com/static/QRQQ.png"
                    ...
                    <div style="padding-bottom: 10px;">
                      ...
                      <n-modal v-model:show="showWCMod">
                        <n-card style="width: 600px" title=" " :bordered="false" size="huge" role="dialog"
                          ...
                          <img src="https://bitnp-website-1258614279.cos.ap-beijing.myqcloud.com/static/QRWechat.png"
                            style="width: 100%; height: 100%;">
                        </n-card>
                      </n-modal>
                    </div>
          ...
          <div id="ffoot">
            <span>
              <n-gradient-text gradient="linear-gradient(62deg, #8EC5FC 0%, #E0C3FC 100%)">
                Copyright &copy; 1997&ndash;2025 <br id="ffot_br"> Net Pioneer Association of BIT All Rights Reserved.
              </n-gradient-text>
            </span>
          </div>
        </n-layout-footer>
