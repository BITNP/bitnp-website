...
import clinicIcon from './assets/clinic2.svg';
import liveIcon from './assets/live2.svg';
import mirrorIcon from './assets/mirror.svg';
import thesisIcon from './assets/thesis.svg';
import mapIcon from './assets/map.svg';
import wikiIcon from './assets/wiki2.svg';
import codimdIcon from './assets/md.svg';

import bb3 from './assets/bb3.svg';
import bb3s from './assets/bb3s.svg';
    ...
    infos: [
      {
        titles: "101的简介",
        linkk: () => {
          window.location.href = shortcut101Img;
        }
      },
      {
        titles: "101背后的故事",
...
<template>
  ...
  <div id="sec1_outer">
    <div id="sec1_bg">
      <div id="sec1_bg_in1">
        <img :src="bb3" id="bg_img_l" style="">
        <img :src="bb3s" id="bg_img_s" style="">
      </div>
    </div>
    <div id="sec1_bd">
        ...
        <n-grid style="height:100%;" cols="1 s:1 l:2" x-gap="0" y-gap="15" item-responsive responsive="screen">
          ...
          <n-gi id="ngrid_R" span="1">
            <div class="box" id="box_ele1">
              <n-carousel direction="horizontal" dot-type="line" dot-placement="bottom" show-arrow="show-arrow"
                autoplay>
                <div class="box_inner" v-for="ele in newsInfo">
                  <div class="box_img">
                    <img :src="ele.imgHref"
                      style="object-fit: cover; width:100%; border-radius: 10px; height: auto; object-position: center;">
                  </div>
                  <div class="box_text">
            ...
            <div class="box" id="box_ele3">
              <n-carousel dot-type="line" dot-placement="bottom" direction="horizontal" show-arrow="show-arrow">
